...
# changing the 'BASIC_AUTH_TOKEN' & 'NEBULA_API_HOST' to you  basic auth key & Nebula api FQDN
# then have your build have an "execute shall" run the following command:
